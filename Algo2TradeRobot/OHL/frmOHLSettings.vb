...
Public Class frmOHLSettings
    ...
    Private Sub LoadSettings()
        If File.Exists(_OHLSettingsFilename) Then
            ...
            txtMaxLossPercentagePerDay.Text = _OHLSettings.MaxLossPerDay
            txtMaxProfitPercentagePerDay.Text = _OHLSettings.MaxProfitPerDay
    ...
    Private Sub SaveSettings()
        ...
        _OHLSettings.MaxLossPerDay = txtMaxLossPercentagePerDay.Text
        _OHLSettings.MaxProfitPerDay = txtMaxProfitPercentagePerDay.Text
