...
Public Class TwoThirdUserInputs
    ...
    Public Property TelegramCashChatID As String
                        ...
                        For rowCtr = 1 To instrumentDetails.GetLength(0) - 1
                            ...
                            If instrumentName IsNot Nothing Then
                                If quantity <> Integer.MinValue OrElse capital <> Decimal.MinValue Then
                                    Dim instrumentDetailsData As New InstrumentDetails
                                    With instrumentDetailsData
                                    ...
                                    'End If
                                    Me.InstrumentsData.Add(instrumentDetailsData.InstrumentName, instrumentDetailsData)
                                Else
