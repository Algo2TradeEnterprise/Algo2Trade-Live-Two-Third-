...
Public Class frmEMA_SupertrendSettings
    ...
    Private Sub LoadSettings()
        If File.Exists(_EMA_SupertrendSettingsFilename) Then
            ...
            txtMaxLossPercentagePerDay.Text = _EMA_SupertrendSettings.MaxLossPerDay
            txtMaxProfitPercentagePerDay.Text = _EMA_SupertrendSettings.MaxProfitPerDay
    ...
    Private Sub SaveSettings()
        ...
        _EMA_SupertrendSettings.MaxLossPerDay = txtMaxLossPercentagePerDay.Text
        _EMA_SupertrendSettings.MaxProfitPerDay = txtMaxProfitPercentagePerDay.Text
